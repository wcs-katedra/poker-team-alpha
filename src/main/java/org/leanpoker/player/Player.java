...
public class Player {
    ...
    public static int betRequest(GameState gameState) {
        ...
        // Pre-flop strategy
        for (int i = 0; i < 3; i++) {
            if (card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[i])) {
                //AA,KK,QQ
                return minimum_raise + 2 * bigBlind;
            }
        }
        if ((card1.getRank().equals(RANKS[0]) && card2.getRank().equals(RANKS[1]))
                || (card1.getRank().equals(RANKS[1]) && card2.getRank().equals(RANKS[0]))) {
            //AK
        ...
        if (gameState.getInAction() == gameState.getDealer() + 1
            ...
            for (int i = 3; i < 6; i++) {
                ...
                //AQ,AJ,AT
                if (card1.getRank().equals(RANKS[0]) && card2.getRank().equals(RANKS[i - 1])) {
                    return minimum_raise;
                }
            }
            ...
            for (int i = 5; i < RANKS.length; i++) {
                //A9s to A2s
                if (card1.getRank().equals(RANKS[0]) && card2.getRank().equals(RANKS[i])
            ...
            for (int i = 2; i < 5; i++) {
                //KQ,KJ,KT
                if ((card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[1])
                        || card1.getRank().equals(RANKS[1])
            ...
            for (int i = 4; i < 5; i++) {
                //QJ,QT
                if ((card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[2])
                        || card1.getRank().equals(RANKS[2])
                        && card2.getRank().equals(RANKS[i]))) {
                    return call;
                }
            }
            for (int i = 3; i < 9; i++) {
                //JTs to 54s
                if ((card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[i + 1])
                        || card1.getRank().equals(RANKS[i + 1])
                        && card2.getRank().equals(RANKS[i]))) {
                    return call;
                }
            }
            ...
            for (int i = 6; i < RANKS.length; i++) {
                ...
                if (card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[i])
                        && gameState.getInAction() == gameState.getDealer() + 4) {
                    return call;
                } else if (card1.getRank().equals(RANKS[i]) && card2.getRank().equals(RANKS[i])) {
                    return minimum_raise;
                }
            }
            ...
            if ((gameState.getInAction() < gameState.getDealer() + 4)) {
                ...
                //JT
                if ((card1.getRank().equals(RANKS[3]) && card2.getRank().equals(RANKS[4])
                        || card1.getRank().equals(RANKS[4])
                        && card2.getRank().equals(RANKS[3]))) {
                    return minimum_raise;
                }
                for (int i = 3; i < 9; i++) {
                    //JTs to 54s
